...
import (
	...
	"github.com/ana-tonic/gopher-social/docs"
...
// @version		1.0.0
// @description	A social network API written in Go
// @host			localhost:8080
// @BasePath		/v1
func (app *application) mount() http.Handler {
	...
	// Swagger docs
	docs.SwaggerInfo.Title = "Gopher Social API"
	docs.SwaggerInfo.Description = "A social network API written in Go"
	...
	r.Route("/v1", func(r chi.Router) {
		...
		docsURL := httpSwagger.URL("http://localhost:8080/v1/swagger/doc.json")
		r.Get("/swagger/*", httpSwagger.Handler(docsURL))
